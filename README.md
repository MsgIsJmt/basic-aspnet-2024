...
## 1일차
- 웹기술 개요
    - World Wide Web (=> WWW) Web은 인터넷의 한 파트
    - Full-Stack : 아래의 3가지를 다 하는 것
        - Front-end : 웹사이트 화면으로 사람들에게 보이는 부분 기술 (뷰)
        - Back-end : 웹사이트 뒤에서 동작하는 서버기술 (모델)
